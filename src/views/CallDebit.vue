    ...
    <v-row>
      ...
      >
        <v-btn
          text
          color="green"
          @click="find_call_debit_spreads"
        >
          Find Call Debit Spreads
        </v-btn>
      </v-col>
    </v-row>
...
<!--          TODO: make new graph for call debit graph-->
          <CallCreditChart
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      find_call_debit_spreads: function () {
        console.log('clicked button');
        api.get_call_debit_spreads(this.ticker, this.expiration)
          .then(data => {
            this.call_debit_spreads = data
          })
      }
