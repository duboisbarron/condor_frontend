  ...
  <v-app>
    ...
    <v-container>
      ...
      <v-row>
        ...
        <v-col cols="2"></v-col>
        <v-col cols="1">
          <v-btn class="mx-2" fab dark color="indigo" @click="increment_num_options">
            <v-icon dark>mdi-plus</v-icon>
          </v-btn>
        </v-col>

        <v-col cols="1">
          <v-btn class="mx-2" fab dark color="indigo" @click="decrement_num_options">
        ...
        <v-col cols="1" align-self="bottom">
          <v-text-field
        ...
        <v-col cols="1" align-self="top">
          <v-btn class="mx-2" dark color="indigo" @click="graph">
            Graph
          </v-btn>
        </v-col>
