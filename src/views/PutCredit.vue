...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      find_put_credit_spreads: function () {

        api.get_put_credit_spreads(this.ticker, this.expiration)
          .then(data => {
            this.put_credit_spreads = data
          })
      }
    },
